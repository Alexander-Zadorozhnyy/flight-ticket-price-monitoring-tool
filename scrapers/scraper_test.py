...
URL = f"https://www.trip.com/flights/showfarefirst?dcity={origin}&acity={destination}&ddate={ddate}&triptype=ow&class=y&lowpricesource=searchform&quantity=1&searchboxarg=t&nonstoponly=off&locale=en-XX&curr=RUB"
