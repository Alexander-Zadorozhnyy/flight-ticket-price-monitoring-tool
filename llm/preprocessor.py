...
2. Обработай даты в русском формате:
   ...
   - "с 10 по 20 января" → start_date: "2024-01-10", end_date: "2024-01-20"
   - "в феврале" → calculate start_date: "2024-02-01", end_date: "2024-02-29"
...
request = "Хочу отслеживать цены на билеты из Москвы в Лондон с 10 по 20 декабря 2024, вылет по пятницам"
