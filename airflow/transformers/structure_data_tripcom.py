...
class TripcomDataTransformer:
    ...
    def structure_flight_output_list(
        ...
        for flight in flights:
            output = self.structure_flight_output(flight, departure_date)
    ...
    def structure_flight_output(
        ...
        try:
            ...
            # Parse price
            price_amount, price_currency = self.parse_price(
                flight_dict.get("price", "")
            )
            ...
            arr_airport = self.extract_airport_code(
